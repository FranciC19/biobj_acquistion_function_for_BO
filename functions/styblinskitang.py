import torch
from botorch.test_functions.synthetic import StyblinskiTang as styblinskitang
...
class StyblinskiTang(Function):
    ...
    def __init__(self, x_size: int):
        ...
        self._obj_f = styblinskitang(dim=x_size, noise_std=None, negate=True, bounds=None)
        self._best_obj_f = 39.166166 * x_size
